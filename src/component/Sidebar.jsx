  ...
  return (
    ...
    >
      ...
      <div className=" flex flex-col gap-y-3 py-4 mt-4">
        ...
        <Link className="bg-gray-200 flex p-1 justify-center items-center texts-center text-primary w-full font-medium">View Cart</Link>
        <Link to={'/'} className="bg-black flex p-1 justify-center items-center texts-center text-white w-full font-medium">Checkout</Link>
      </div>
    </div>
  );
};
